    ...
    return(
        <div className="min-h-screen grid grid-col-1 lg:grid-cols-6">
            ...
            <div className="col-span-5">
                ...
                {/* CARDS */}
                <Link to={"/employees"} className="bg-white rounded-3xl p-8 flex flex-col md:flex-row gap-8 w-full shadow-lg border-2 border-transparent hover:border-blue-400 transition-all mb-6">
                    {/* ICON */}
                    <div className="w-full md:w-[10%] flex items-center justify-start md:justify-center">
                        <RiTeamLine className="text-7xl bg-blue-100 text-blue-600 p-4 rounded-md" />
                    </div>
                    {/* TITLE */}
                    <div className="w-full md:w-[70%]">
                        <h1 className="text-xl flex items-center gap-4 mb-2">
                            Employees <span className="text-xs py-1 px-2 bg-blue-100 text-blue-600 font-bold">Super admin</span>
                    ...
                    <div className="w-full md:w-[20%] flex flex-col justify-end items-end">
                        <button className="bg-blue-600 hover:bg-blue-400 text-white font-bold py-2 px-4 rounded-full">Go to module</button>
                    </div>
                </Link>

                <Link to={"/customers"} className="bg-white rounded-3xl p-8 flex flex-col md:flex-row gap-8 w-full shadow-lg border-2 border-transparent hover:border-blue-400 transition-all mb-6">
                    {/* ICON */}
                    <div className="w-full md:w-[10%] flex items-center justify-start md:justify-center">
                        <RiContactsFill className="text-7xl bg-blue-100 text-blue-600 p-4 rounded-md" />
                    </div>
                    {/* TITLE */}
                    <div className="w-full md:w-[70%]">
                        <h1 className="text-xl flex items-center gap-4 mb-2">
                            Customers <span className="text-xs py-1 px-2 bg-blue-100 text-blue-600 font-bold">Super admin</span>
                            <span className="text-xs py-1 px-2 bg-green-100 text-green-600 font-bold">Admin</span> 
                        </h1>
                ...
                <Link to={"/companies"} className="bg-white rounded-3xl p-8 flex flex-col md:flex-row gap-8 w-full shadow-lg border-2 border-transparent hover:border-blue-400 transition-all mb-6">
                    {/* ICON */}
                    <div className="w-full md:w-[10%] flex items-center justify-start md:justify-center">
                        <RiCommunityFill className="text-7xl bg-blue-100 text-blue-600 p-4 rounded-md" />
                    </div>
                    {/* TITLE */}
                    <div className="w-full md:w-[70%]">
                        <h1 className="text-xl flex items-center gap-4 mb-2">
                            Companies <span className="text-xs py-1 px-2 bg-blue-100 text-blue-600 font-bold">Super admin</span>
                            <span className="text-xs py-1 px-2 bg-green-100 text-green-600 font-bold">Admin</span>
